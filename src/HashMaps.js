//HashMaps
    // A HashMap is like a drawer that stores items in bins and labels them. Hash map implementations use a hashtable. Note that a hashtable is a data strucutre that maps keys to values 
