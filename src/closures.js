...
//when assigning the function clickHandler then, we shouldn't be invoking it! However this poses a problem because we have no way of passing the size argument.

//How do we solve this problem? With an inner function!
